...
var PoliticsArticleComponent = (function () {
    function PoliticsArticleComponent(articleService, modal, overlay, vcRef) {
    ...
    PoliticsArticleComponent.prototype.ngOnInit = function () {
        this.commentCount = 0;
        this.idAppender = 0;
        this.testAppender = 0;
    };
    PoliticsArticleComponent.prototype.OpenPopup = function (articleType) {
        var _this = this;
    ...
    PoliticsArticleComponent.prototype.showCoords = function (event) {
        this.xPostion = event.clientX;
        this.yPosition = event.clientY;
    };
    PoliticsArticleComponent.prototype.GetCoordinates = function () {
    ...
    PoliticsArticleComponent.prototype.getCommentData = function (id, articleType) {
        var _this = this;
    ...
    PoliticsArticleComponent = __decorate([
        core_1.Component({
            selector: 'politics-article',
            template: require('./politics.component.html'),
    ...
    ], PoliticsArticleComponent);
    return PoliticsArticleComponent;
}());
exports.PoliticsArticleComponent = PoliticsArticleComponent;
