...
var BusinessArticleComponent = (function () {
    function BusinessArticleComponent(articleService, modal, overlay, vcRef) {
    ...
    BusinessArticleComponent.prototype.ngOnInit = function () {
        this.commentCount = 0;
        this.idAppender = 0;
        this.testAppender = 0;
    };
    BusinessArticleComponent.prototype.OpenPopup = function (articleType) {
        var _this = this;
    ...
    BusinessArticleComponent.prototype.showCoords = function (event) {
        this.xPostion = event.clientX;
        this.yPosition = event.clientY;
    };
    BusinessArticleComponent.prototype.GetCoordinates = function () {
    ...
    BusinessArticleComponent.prototype.getCommentData = function (id, articleType) {
        var _this = this;
    ...
    BusinessArticleComponent = __decorate([
        core_1.Component({
    ...
    return BusinessArticleComponent;
}());
exports.BusinessArticleComponent = BusinessArticleComponent;
