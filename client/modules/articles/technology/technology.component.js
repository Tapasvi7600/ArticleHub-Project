...
var TechnologyArticleComponent = (function () {
    function TechnologyArticleComponent(articleService, modal, overlay, vcRef) {
    ...
    TechnologyArticleComponent.prototype.ngOnInit = function () {
        this.commentCount = 0;
        this.idAppender = 0;
        this.testAppender = 0;
    };
    TechnologyArticleComponent.prototype.OpenPopup = function (articleType) {
        var _this = this;
    ...
    TechnologyArticleComponent.prototype.showCoords = function (event) {
        this.xPostion = event.clientX;
        this.yPosition = event.clientY;
    };
    TechnologyArticleComponent.prototype.GetCoordinates = function () {
    ...
    TechnologyArticleComponent.prototype.getCommentData = function (id, articleType) {
        var _this = this;
    ...
    TechnologyArticleComponent = __decorate([
        core_1.Component({
            selector: 'technology-article',
    ...
    ], TechnologyArticleComponent);
    return TechnologyArticleComponent;
}());
exports.TechnologyArticleComponent = TechnologyArticleComponent;
